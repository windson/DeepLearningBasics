...
class Net(nn.Module):
    def __init__(self,disable_drop_out = False, drop_out=0.5, weight_init =''):
...
def main():
    ...
    #weight initializer
    parser.add_argument('--init', type=str, metavar='I', default='',
                        help='Weight Initializer like kaiming / xavier')
    ...
    model = Net(is_drop_out, drop_out,args.init.lower()).to(device)
